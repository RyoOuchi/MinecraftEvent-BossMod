...
public class ApolloTeleportGoal extends Goal {
    private final ApolloBoss apolloBoss;

    public ApolloTeleportGoal(ApolloBoss apolloBoss) {
    ...
    public boolean canUse() {
        ...
        return !this.apolloBoss.isBeamReady() &&
                this.apolloBoss.distanceToSqr(target) > distance * distance;
    }

    @Override
    public void start() {
        teleportBoss(this.apolloBoss.level, this.apolloBoss.getTarget(), this.apolloBoss);
        super.start();
    }
